...
Object.defineProperty(config, 'PORT', {
  ...
  set: function (value) {
    ...
    if (!isNaN(value) && value > 0 && value <= 65535 && value !== props.PORT) {
      props.PORT = value;
    }
  }
});
...
Object.defineProperty(config, 'SAVE_FILE', {
  enumerable: true,
  get: function () {
    return props.SAVE_FILE;
  },
  set: function (value) {
    props.SAVE_FILE = !!parseInt(value, 10);
  }
});
...
Object.defineProperty(config, 'MAX_AGE', {
  ...
  set: function (value) {
    value = parseInt(value, 10);
    if (value >= 0) {
      props.MAX_AGE = parseInt(value, 10);
    }
  }
});
...
Object.defineProperty(config, 'ACH_LIFETIME', {
  ...
  set: function (value) {
    value = parseInt(value, 10);
    if (value >= 0) {
      props.ACH_LIFETIME = parseInt(value, 10);
    }
  }
});
